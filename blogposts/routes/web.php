...
Route::resource('/posts', PostsController::class)->except(['create','store','edit','update','destroy']);
Route::resource('/comments', CommentsController::class)->except(['index', 'show'])->middleware('auth');
